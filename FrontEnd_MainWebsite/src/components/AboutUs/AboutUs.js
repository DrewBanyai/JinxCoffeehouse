...
import { CarouselButton, CarouselButtonDot, CarouselButtons, CarouselContainer, CarouselItem, CarouselItemImg, CarouselItemText, CarouselItemTitle, CarouselMobileScrollNode } from './AboutUsStyles';
...
const AboutUs = () => {
  ...
  return (
    <Section id="about">
      <SectionTitle>About Jinx</SectionTitle>
      <SectionText>
